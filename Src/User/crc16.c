//*****************************************************************************
//
//crc16.c - CRC driver to provide CRC functions for MODBUS
//author:kimi
//date:  2017/08/20
//
//*****************************************************************************
...
bool CheckCRC(uint8_t *ptr, uint8_t len)
{
	...
	crc = GetCRC16(ptr, len-2); //计算 CRC 校验值
	crch = crc >> 8;
	crcl = crc & 0xFF;
	
	if ((ptr[len-2]!=crch) || (ptr[len-1]!=crcl))
	{
		return 0; 
	}
	return 1;
